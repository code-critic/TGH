...
- Seems that this solution takes number of connections into account, while the setting of the problem do not.
  This leads to queries with non-unique solutions that are not detected by this solution.
- Remove loops.
